...
export default function Curaflow() {
	return (
		<Flex className="h-full w-full rounded-lg curaflow-scrollbar font-sketchy overflow-hidden">
			<Flex
				isColumn
				gap="3"
			...
			>
				...
				<Flex isColumn gap="2" align="center" isWrapped>
					<Image
						src={curaflow_hero_en}
						width={1000}
						height={1000}
						alt="Curaflow Hero English"
					/>
					<Image
						src={curaflow_hero_ar}
						width={1000}
						height={1000}
						alt="Curaflow Hero Arabic"
					/>
				</Flex>
				...
				<Section title="Project Status">
					...
					by us but is not open-sourced due to the client&apos;s
					...
					<Flex isColumn gap="4">
						...
						<div>
							...
							<ul className="list-disc list-inside space-y-1 text-gray-700">
								...
								<li>
									View Appointments by Date, Patient, or
									Employee
								</li>
								<li>Cancel or fast forward appointments</li>
								<li>
									Fill in the patient&apos;s medical record
									during the appointment
								</li>
								<li>
									Fill custom forms during the appointment
									(e.g. Patient data form) to be saved in the
						...
						<div>
							...
							<ul className="list-disc list-inside space-y-1 text-gray-700">
								...
								<li>
									Create a schedule for the employees with
									ability to add overtime or vacation
								</li>
								<li>
									Create an account with custom role and
									permissions for each employee and track
									their activity
								</li>
								<li>
									Create a list of medical services and nested
									categories and assign the services to the
									doctors with the ability to add different
									prices for each doctor
								</li>
							</ul>
						</div>
						...
						<div>
							...
							<ul className="list-disc list-inside space-y-1 text-gray-700">
								<li>
									View charts and statistics for the
									clinic&apos;s performance and the
									employees&apos; performance
								</li>
								<li>
									Create, Edit, Delete forms to be filled
									during the appointment
								</li>
								<li>
									Send bulk SMSs or Emails to patients or a
									subset of patients based on filters
								</li>
								<li>
								...
								<li>
									Send announcements to all employees or a
									subset of them based on filters
								</li>
				...
				<Section title="Development Process">
					<Flex isColumn gap="4">
						<div>
							...
							<Label>
								We used React and TS for the frontend and
								Node.js for the backend, the database was
								NeonDB. The frontend was made with TailwindCSS
								and designed with Figma by{" "}
								<a
									href="https://github.com/ammarmbe"
									target="_blank"
									className="text-blue-500 underline hover:text-blue-700"
						...
						<div>
							...
							<Label>
								We used Apache Echarts for the charts and
								statistics with customised themes and designs.
								The data was fetched from the backend and was
								processed and transformed to be displayed in the
								charts.
							</Label>
						</div>
					</Flex>

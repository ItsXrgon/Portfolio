...
import { formatLocaleTime } from "@/lib/formatting/date";
	...
	return (
		<Flex gap="1" className="w-full overflow-y-scroll bg-black text-white">
			...
			>
				...
				<Flex gap="1" align="center" isWrapped>
					<Label.Thin200>
				...
				<Flex gap="2" isColumn align="start" justify="start" isWrapped>
					{profile?.location && (
						<Flex gap="3" align="center" isWrapped>
					...
					)}
					{
						<Flex gap="2" align="center" isWrapped>
							...
							<Label.Thin200>
								{`${formatLocaleTime(time)} (${formattedTimeZone})`}
							</Label.Thin200>

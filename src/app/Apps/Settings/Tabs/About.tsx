			...
			<Flex isColumn gap="2">
				...
				<Flex isColumn gap="1">
					...
					<Label.Mid300>
						...
						object which serves as the default theme so updating
						that auto updates the theme options. I just have to
						manually create a CSS variable for every palette.
					</Label.Mid300>
				</Flex>
			</Flex>
			<Flex isColumn gap="2">

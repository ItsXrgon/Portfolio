const palette = {
	desktop: {
		...
		app: {
			...
			hover: {
				background: 'rgba(var(--desktop-app-hover-background) / <alpha-value>)',
				text: 'rgba(var(--desktop-app-hover-text) / <alpha-value>)',
			},
			drag: {
				background: 'rgba(var(--desktop-app-drag-background) / <alpha-value>)',
	...
	taskbar: {
		...
		app: {
			...
			open: {
				background: 'rgba(var(--taskbar-app-open-background) / <alpha-value>)',
				indicator: 'rgba(var(--taskbar-app-open-indicator) / <alpha-value>)',
			},
			drag: {
				background: 'rgba(var(--taskbar-app-drag-background) / <alpha-value>)',
			},
		},
	...
	window: {
		...
		header: {
			...
			icon: {
				default: 'rgba(var(--window-header-icon-default) / <alpha-value>)',
				hovered: 'rgba(var(--window-header-icon-hovered) / <alpha-value>)',
				pressed: 'rgba(var(--window-header-icon-pressed) / <alpha-value>)',
			},
		},
	},
	button: {
		primary: {
			...
			icon: {
				default: 'rgba(var(--action-primary-icon-default) / <alpha-value>)',
				hovered: 'rgba(var(--action-primary-icon-hovered) / <alpha-value>)',
				pressed: 'rgba(var(--action-primary-icon-pressed) / <alpha-value>)',
				disabled: 'rgba(var(--action-primary-icon-disabled) / <alpha-value>)',
			},
		},
		white: {
			...
			icon: {
				default: 'rgba(var(--action-white-icon-default) / <alpha-value>)',
				hovered: 'rgba(var(--action-white-icon-hovered) / <alpha-value>)',
				pressed: 'rgba(var(--action-white-icon-pressed) / <alpha-value>)',
				disabled: 'rgba(var(--action-white-icon-disabled) / <alpha-value>)',
			},
		},
		success: {
			...
			icon: {
				default: 'rgba(var(--action-success-icon-default) / <alpha-value>)',
				hovered: 'rgba(var(--action-success-icon-hovered) / <alpha-value>)',
				pressed: 'rgba(var(--action-success-icon-pressed) / <alpha-value>)',
				disabled: 'rgba(var(--action-success-icon-disabled) / <alpha-value>)',
			},
		},
		warning: {
			...
			icon: {
				default: 'rgba(var(--action-warning-icon-default) / <alpha-value>)',
				hovered: 'rgba(var(--action-warning-icon-hovered) / <alpha-value>)',
				pressed: 'rgba(var(--action-warning-icon-pressed) / <alpha-value>)',
				disabled: 'rgba(var(--action-warning-icon-disabled) / <alpha-value>)',
			},
		},
		critical: {
			...
			icon: {
				default: 'rgba(var(--action-critical-icon-default) / <alpha-value>)',
				hovered: 'rgba(var(--action-critical-icon-hovered) / <alpha-value>)',
				pressed: 'rgba(var(--action-critical-icon-pressed) / <alpha-value>)',
				disabled: 'rgba(var(--action-critical-icon-disabled) / <alpha-value>)',
			},
		},
	},
	shadow: {

...
export function useRepositories() {
	...
	const repos = isReposError || isReposLoading || !data ? hardCodedRepos : data;
...
const hardCodedRepos: TGithubRepo[] = [
	{
		...
		forks_url: 'https://api.github.com/repos/ItsXrgon/Check-Calculator/forks',
		keys_url:
		...
		teams_url: 'https://api.github.com/repos/ItsXrgon/Check-Calculator/teams',
		hooks_url: 'https://api.github.com/repos/ItsXrgon/Check-Calculator/hooks',
		issue_events_url:
			'https://api.github.com/repos/ItsXrgon/Check-Calculator/issues/events{/number}',
		events_url: 'https://api.github.com/repos/ItsXrgon/Check-Calculator/events',
		assignees_url:
		...
		merges_url: 'https://api.github.com/repos/ItsXrgon/Check-Calculator/merges',
		archive_url:
		...
		updated_at: '2023-06-19T19:17:47Z',
		pushed_at: '2023-06-19T19:17:43Z',
	...
	},
	{
		...
		forks_url: 'https://api.github.com/repos/ItsXrgon/Haskell-Chess-Game/forks',
		keys_url:
		...
		teams_url: 'https://api.github.com/repos/ItsXrgon/Haskell-Chess-Game/teams',
		hooks_url: 'https://api.github.com/repos/ItsXrgon/Haskell-Chess-Game/hooks',
		issue_events_url:
		...
		tags_url: 'https://api.github.com/repos/ItsXrgon/Haskell-Chess-Game/tags',
		blobs_url:
	...
	},
	{
		...
		keys_url: 'https://api.github.com/repos/ItsXrgon/ItsXrgon/keys{/key_id}',
		collaborators_url:
		...
		blobs_url: 'https://api.github.com/repos/ItsXrgon/ItsXrgon/git/blobs{/sha}',
		git_tags_url:
			'https://api.github.com/repos/ItsXrgon/ItsXrgon/git/tags{/sha}',
		git_refs_url:
			'https://api.github.com/repos/ItsXrgon/ItsXrgon/git/refs{/sha}',
		trees_url: 'https://api.github.com/repos/ItsXrgon/ItsXrgon/git/trees{/sha}',
		statuses_url:
			'https://api.github.com/repos/ItsXrgon/ItsXrgon/statuses/{sha}',
		languages_url: 'https://api.github.com/repos/ItsXrgon/ItsXrgon/languages',
		stargazers_url: 'https://api.github.com/repos/ItsXrgon/ItsXrgon/stargazers',
		contributors_url:
		...
		commits_url: 'https://api.github.com/repos/ItsXrgon/ItsXrgon/commits{/sha}',
		git_commits_url:
		...
		downloads_url: 'https://api.github.com/repos/ItsXrgon/ItsXrgon/downloads',
		issues_url:
			'https://api.github.com/repos/ItsXrgon/ItsXrgon/issues{/number}',
		pulls_url: 'https://api.github.com/repos/ItsXrgon/ItsXrgon/pulls{/number}',
		milestones_url:
		...
		labels_url: 'https://api.github.com/repos/ItsXrgon/ItsXrgon/labels{/name}',
		releases_url:
	...
	},
	{
		...
		forks_url: 'https://api.github.com/repos/ItsXrgon/Last-Of-Us-Legacy/forks',
		keys_url:
		...
		teams_url: 'https://api.github.com/repos/ItsXrgon/Last-Of-Us-Legacy/teams',
		hooks_url: 'https://api.github.com/repos/ItsXrgon/Last-Of-Us-Legacy/hooks',
		issue_events_url:
		...
		tags_url: 'https://api.github.com/repos/ItsXrgon/Last-Of-Us-Legacy/tags',
		blobs_url:
	...
	},
	{
		...
		tags_url: 'https://api.github.com/repos/ItsXrgon/multi-unit-converter/tags',
		blobs_url:
	...
	},
	{
		...
		keys_url: 'https://api.github.com/repos/ItsXrgon/UniScripts/keys{/key_id}',
		collaborators_url:
		...
		languages_url: 'https://api.github.com/repos/ItsXrgon/UniScripts/languages',
		stargazers_url:
		...
		downloads_url: 'https://api.github.com/repos/ItsXrgon/UniScripts/downloads',
		issues_url:
	...
	},
	{
		...
		keys_url: 'https://api.github.com/repos/ItsXrgon/UserPurge/keys{/key_id}',
		collaborators_url:
		...
		languages_url: 'https://api.github.com/repos/ItsXrgon/UserPurge/languages',
		stargazers_url:
		...
		downloads_url: 'https://api.github.com/repos/ItsXrgon/UserPurge/downloads',
		issues_url:
			'https://api.github.com/repos/ItsXrgon/UserPurge/issues{/number}',
		pulls_url: 'https://api.github.com/repos/ItsXrgon/UserPurge/pulls{/number}',
		milestones_url:
		...
		labels_url: 'https://api.github.com/repos/ItsXrgon/UserPurge/labels{/name}',
		releases_url:
	...
	},
	{
		...
		forks_url: 'https://api.github.com/repos/ItsXrgon/XrBot-DiscordBot/forks',
		keys_url:
		...
		teams_url: 'https://api.github.com/repos/ItsXrgon/XrBot-DiscordBot/teams',
		hooks_url: 'https://api.github.com/repos/ItsXrgon/XrBot-DiscordBot/hooks',
		issue_events_url:
			'https://api.github.com/repos/ItsXrgon/XrBot-DiscordBot/issues/events{/number}',
		events_url: 'https://api.github.com/repos/ItsXrgon/XrBot-DiscordBot/events',
		assignees_url:
		...
		merges_url: 'https://api.github.com/repos/ItsXrgon/XrBot-DiscordBot/merges',
		archive_url:
